...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        this.findViewById(R.id.main_delete_again_multi_download).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.main_multi_download:
                ...
                break;
            case R.id.main_delete_again_multi_download:
                startAgainMultiDownload();
                break;
        }
    }
    ...
    private void startAgainMultiDownload() {
        String url2 = "http://yun.aiwan.hk/1441972507.apk";
        String filePath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + File.separator + "baihewang.apk";
        multiDownLoadTask = DownloadClient.getInstance().againStartMultiDownLoadTask(url2, filePath,
                new ProgressListener() {
                    @Override
                    public void progress(String url, int progress) {
                        Log.i(TAG, "   MultiDownload   progress " + progress);
